...
'''
'''
思路一：按之字形顺序打印二叉树需要两个栈。我们在打印某一行节点时，拔下一层的子节点保存到相应的栈里。
...
class Solution:
    def Print(self, pRoot):
        ...
        result,nodes = [],[pRoot]
        right = True
        # 处理思路很好的，有一个二级机制，通过nextStack存下一节点的，
        # 这节点里面的值通过=nodes再转移到curStack里面
